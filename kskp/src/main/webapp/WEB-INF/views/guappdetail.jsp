...
<tr>
	<td colspan="3"><textarea class="wrap" onkeyup="this.style.height='26px'; this.style.height = this.scrollHeight + 'px';" type="text" readonly="readonly">${dto.gu_intro}</textarea></td>
</tr>
<tr>
	<td colspan="3" align="right"><button onclick="location.href='guideapp.do?gu_seq=${dto.gu_seq}'">가입승인</button>
