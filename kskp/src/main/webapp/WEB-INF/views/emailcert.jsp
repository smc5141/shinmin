   ...
   <script>
      ...
      $(function(){
		  ...
		  $(".tab_content:first").show(); 
    	    ...
    	    $(".tab").click(function () {
    	        $(".tab").removeClass("active").css("color", "#333");
...
<div class='member-panel-tabs clearfix tabs'>
<div class='tab active' rel="tab1" id="phonebtn" data-tab-target='phone'>휴대폰 인증</div>
<div class='tab' rel="tab2"  id="emailbtn" data-tab-target='email'>이메일 인증</div>
</div>
<div class='member-panel member-panel--with-tab'>
<div class='panel-body'>
<div class='panel-body--phone-verification' data-panel-target='phone'>
<form name="send_code_form" role="form" data-validation="true" action="minsertuser1.do" accept-charset="UTF-8" method="post">
...
<div class='row'>
<div class='col-xs-12'>
<input class='form-control'name="pcer" id="send"  placeholder='- 없이 작성해주세요.' title='휴대폰 번호' type='text'>
</div>
</div>
</div>
</div>
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100' id="phBtn"  type='button'>문자로 인증번호 보내기</button>
</div>
</c:when>
...
<div class='row'>
<div class='col-xs-12'>
<input class='form-control' name="pcer" id="send" placeholder="인증번호를 입력해주세요">
</div>
</div>
</div>
</div>
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100'   type='submit'>인증하기</button>
</div>
</c:otherwise>
 </c:choose>
</div>
...
<form name="send_code_form" role="form" data-validation="true" action="minsertuser.do" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="cF/gc5HH490BXo5PPQJmpRmtmd6db6g6He0fGbLAYY+Ut0kNn2rcLwGOEvt30DYlcEz+PXL3slHNMBxP+bFxwg==" />
<input type="hidden" name="email" value="${dto.m_email}">
<div class='form-wrapper tab_content' id="tab2">
<c:choose>
...
<div class='row'>
<div class='col-xs-12'>
<input class='form-control' name="email"  id="em" placeholder='xxx@aaa.com' title="이메일주소" type="email" readonly="readonly" value="${dto.m_email}">
</div>
</div>
</div>
</div>
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100' id="emBtn"  data-gtm-action='이메일로 인증번호 보내기' data-gtm-category='통합인증'  type='button'>이메일로 인증번호 보내기</button>
</div>
</c:when>
...
<div class='btn-wrap'>
<button class='btn-new btn--type-primary btn--width-100' id="sub" value="인증하기" data-gtm-action='문자로 인증번호 보내기' data-gtm-category='통합인증'  type='submit'>문자로 인증번호 보내기</button>
</div>       			
       			</c:otherwise>
	</c:choose>
</div>
